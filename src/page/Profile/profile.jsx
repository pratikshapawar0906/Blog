...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:7000/api/user/${storedUserId}`)
      .then((response) => {
        setUser({
          ...response.data,
    ...
    try {
      ...
      if (newProfilePicture) {
        ...
        const response = await axios.post(
          `http://localhost:7000/api/user/uploadProfilePhoto`,
          formData,
      ...
      await axios.put(`http://localhost:7000/api/updateProfile`, {
        userId: storedUserId,
        name: user.name,
        bio: user.bio,
            ...
            <div key={platform}>
              ...
              <input
                ...
                onChange={(e) =>
                  setUser((prevUser) => ({
                    ...prevUser,
                    socialLinks: { ...prevUser.socialLinks, [platform]: e.target.value },
                  }))
                }
                placeholder="https://"
              />
